...
- Formulier om nieuwe auto's toe te voegen én bestaande te bewerken/verwijderen: kies garage/verdieping/plek en typ een model (met suggesties uit eerder gebruikte modellen); merk, type en afbeeldingen worden automatisch opgehaald van GTABase of gevuld met lokale placeholders/offline fallback. Verwijderen gaat via een prullenbak-icoon.
