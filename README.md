...
- Virtuele plattegrond: kies een garage en verdieping, koppel auto's aan parkeerplekken en verplaats auto's naar andere plekken of verdiepingen binnen dezelfde garage.
...
- Suggestielijst voor garages (onthoudt eerder ingevoerde namen) en een model-datalist gevuld uit je eigen data; bij het typen zoekt de tool live op GTABase en vult merk, type en afbeeldingen in (met offline fallback wanneer GTABase niet bereikbaar is).
